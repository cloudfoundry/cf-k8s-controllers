...
func (r *Reconciler) ReconcileResource(ctx context.Context, cfApp *korifiv1alpha1.CFApp) (ctrl.Result, error) {
	...
	cfApp.Status.ServiceBindings = bindingObjects(bindings)
...
func bindingObjects(bindings []korifiv1alpha1.CFServiceBinding) []corev1.ObjectReference {
	return slices.Collect(it.Map(slices.Values(bindings), func(binding korifiv1alpha1.CFServiceBinding) corev1.ObjectReference {
