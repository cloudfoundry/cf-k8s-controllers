...
type CFServiceBindingRepository struct {
	...
	GetServiceBindingParametersStub        func(context.Context, authorization.Info, string) (repositories.ServiceBindingParametersRecord, error)
	...
	getServiceBindingParametersReturns struct {
		result1 repositories.ServiceBindingParametersRecord
		result2 error
	}
...
func (fake *CFServiceBindingRepository) GetServiceBindingParameters(arg1 context.Context, arg2 authorization.Info, arg3 string) (repositories.ServiceBindingParametersRecord, error) {
...
func (fake *CFServiceBindingRepository) GetServiceBindingParametersCalls(stub func(context.Context, authorization.Info, string) (repositories.ServiceBindingParametersRecord, error)) {
	fake.getServiceBindingParametersMutex.Lock()
...
func (fake *CFServiceBindingRepository) GetServiceBindingParametersReturns(result1 repositories.ServiceBindingParametersRecord, result2 error) {
	fake.getServiceBindingParametersMutex.Lock()
	defer fake.getServiceBindingParametersMutex.Unlock()
...
func (fake *CFServiceBindingRepository) GetServiceBindingParametersReturnsOnCall(i int, result1 repositories.ServiceBindingParametersRecord, result2 error) {
	fake.getServiceBindingParametersMutex.Lock()
	defer fake.getServiceBindingParametersMutex.Unlock()
	fake.GetServiceBindingParametersStub = nil
